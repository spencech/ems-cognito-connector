...
var jwtDecode = Decoded.jwtDecode;
function Authenticator(UserPoolId, ClientId, IdToken, AccessToken, RefreshToken) {
  ...
  var idTokenObj = new _amazonCognitoIdentityJs.CognitoIdToken({
    IdToken: IdToken
  });
  var accessTokenObj = new _amazonCognitoIdentityJs.CognitoAccessToken({
    AccessToken: AccessToken
  });
  var refreshTokenObj = new _amazonCognitoIdentityJs.CognitoRefreshToken({
    RefreshToken: RefreshToken
  });
  var session = new _amazonCognitoIdentityJs.CognitoUserSession({
    IdToken: idTokenObj,
...
Authenticator.prototype.requestOtp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(OnGenerateOtpEndpoint, OnMailOtpEndpoint) {
    var _this = this;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 3;
          return _axios["default"].post(OnGenerateOtpEndpoint, {
            otp: "otp",
            username: this.Username
          }, {
            headers: {
                  ...
                  case 0:
                    handler = {
                      ...
                      customChallenge: function () {
                        var _customChallenge = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(challengeParameters) {
                          var sent;
                          return _regeneratorRuntime().wrap(function _callee$(_context) {
                            while (1) switch (_context.prev = _context.next) {
                              case 0:
                                _context.next = 2;
                                return _axios["default"].post(OnMailOtpEndpoint, {
...
Authenticator.prototype.submitOtp = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(ChallengeResponse) {
    var _this2 = this;
              ...
              return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                while (1) switch (_context6.prev = _context6.next) {
                  case 0:
                    handler = {
                      onSuccess: function () {
                        var _onSuccess = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(session) {
                      ...
                      customChallenge: function () {
                        var _customChallenge2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(challengeParameters) {
...
Authenticator.prototype.submitPassword = function (Password) {
  ...
  return new Promise(function (resolve, reject) {
    _this3.User.authenticateUser(_this3.Details, {
      onSuccess: function onSuccess(session) {
        _this3.RefreshToken = session.refreshToken;
        resolve({
          status: "success",
          token: session.idToken.jwtToken,
          session: session
...
Authenticator.prototype.changePassword = function (oldPassword, newPassword) {
  var _this4 = this;
  return new Promise(function (resolve, reject) {
    _this4.User.changePassword(oldPassword, newPassword, function (error, result) {
      if (error) resolve({
        status: "failure",
        error: error
      });else resolve({
...
Authenticator.prototype.setNewPasswordWithResetCode = function (code, password) {
  var _this6 = this;
  return new Promise(function (resolve, reject) {
    _this6.User.confirmPassword(code, password, {
      onSuccess: function onSuccess(response) {
        resolve({
          status: "success",
          user: _this6.User
...
Authenticator.prototype.refreshToken = function () {
  var _this7 = this;
  return new Promise(function (resolve, reject) {
    _this7.User.refreshSession(_this7.RefreshToken, function (error, session) {
      if (error) resolve({
        status: "failure",
        error: error
      });else {
        _this7.RefreshToken = session.refreshToken;
        resolve({
          status: "success",
          token: session.idToken.jwtToken,
          session: session
